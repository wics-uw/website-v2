const missionStrings = {
  ...
  missionDescription: 'Women in Computer Science (WiCS) is dedicated to promoting women who are interested in studying computer science and who seek to pursue careers in computing.',
  community: {
    title: 'Community',
